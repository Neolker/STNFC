...
/** @defgroup STM32G0XX_NUCLEO STM32G0XX_NUCLEO
 * @{
 */

/** @defgroup STM32G0XX_NUCLEO_LOW_LEVEL STM32G0XX_NUCLEO LOW LEVEL
 *  @brief This file provides set of firmware functions to manage Leds and push-button
 *         available on STM32G0xx-Nucleo Kit from STMicroelectronics.
 * @{
 */
...
/** @defgroup STM32G0XX_NUCLEO_LOW_LEVEL_Private_Defines STM32G0XX_NUCLEO LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STM32G0XX_NUCLEO_LOW_LEVEL_FunctionPrototypes STM32G0XX_NUCLEO LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STM32G0XX_NUCLEO_LOW_LEVEL_Private_Variables STM32G0XX_NUCLEO LOW LEVEL Private Variables
 * @{
 */
...
{
  return (int32_t)__STM32G0XX_NUCLEO_BSP_VERSION;
}
